...
guix time-machine --commit=0daa747de24a9739b32a13e0c55ae2bfe4666bf1 -C $DEFAULT_CHANNELS -- shell --expose=$HOME/.local/ -F --preserve='^DISPLAY$' --share=$HOME/.cache -N --expose=/etc/machine-id --container python python-pandas gcc:lib nss nss-certs curl -D icecat
